        ...
        <div className="lineup-inner">
          ...
          <div className="lineup-body">
            <div className="artist-block">
              ...
              <div className="tier-5 reveal reveal-d4">JOVANIE<span className="dot-3">·</span>LIZZY ASHLEIGH<span className="dot-3">·</span>TRAP SUSHI<span className="dot-3">·</span>CHERELE<span className="dot-3">·</span>SLAYR</div>
